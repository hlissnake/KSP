...
module.exports = {
    ...
    combo_with_config: function( pkgConfig, moduleContentPath, outputPackagePath, outputPath ){
    ...
    build: function( kspConfig, mainPath, ifComboConfig ){
        ...
        var mainModuleExtname = Path.extname( mainModulePath );

        // Remove extname.
        if( mainModuleExtname ){
            mainModulePath = mainModulePath.substring( 0, mainModulePath.indexOf( mainModuleExtname ) );
        ...
        if( ifComboConfig ){
            ...
            var outputPackagePath = Path.relative( kspConfig.path, outputPath );
            ...
            this.combo_with_config({
                ...
                tag: kspConfig.tag,
                charset: kspConfig.charset
            }, outputPath, outputPackagePath, outputPath );
        }
    }
};